...
import com.example.serap.multilevelexpandablelistview.adapter.FirstLevelAdapter;

public class MultiLevelExpandableListActivity extends AppCompatActivity {
  ...
  /*  Retrofit retrofit = new Retrofit.Builder()
    ...
    multiLevelExpandableListView.setAdapter(
        new FirstLevelAdapter(MultiLevelExpandableListActivity.this));
